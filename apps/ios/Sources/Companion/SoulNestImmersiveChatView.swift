...
struct SoulNestImmersiveChatView: View {
    ...
    private func messageBubble(_ message: SoulNestChatMessage) -> some View {
        ...
        HStack(alignment: .bottom, spacing: 8) {
            ...
            Text(displayedText.isEmpty ? "…" : displayedText)
                ...
                .padding(.vertical, 8)
                .background(message.role == .user ? OpenClawBrand.accent : OpenClawBrand.graphiteElevated)
    ...
    private var thinkingIndicator: some View {
        ...
        .padding(12)
        .background(OpenClawBrand.graphiteElevated)
        .clipShape(Capsule())
    ...
    private var inputBar: some View {
        HStack(spacing: 12) {
            TextField("", text: self.$textInput, prompt: Text("Message").font(.body), axis: .horizontal)
                .font(.body)
